...
abstract class Monetbil
{
     ...
     * @return array ($payment_status, $testmode)
     */
    public static function checkPaymentAndReturnTransaction($paymentId)
    {
        $postData = array(
            'paymentId' => $paymentId
        );
     ...
     * @return string
     */
    public static function payoutUrl($monetbil_args = array())
    {
        $monetbil_args['service_key'] = Monetbil::getServiceKey();
        $monetbil_args['service_secret'] = Monetbil::getServiceSecret();
        ...
        /*if (is_array($result) and array_key_exists('payout_url', $result)) {
            $payout_url = $result['payout_url'];
        }*/
